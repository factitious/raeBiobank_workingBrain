...
#### Feature selection/extraction using (only) prior domain-specific knowledge. 
...
- In the case of CCA you can still relate your variates to the original features through
  ...
  - canonical loadings = direct contribution of one feature to its respective canonical variate regardless of other features (interpreted as in PCA); e.g. corr(X1,u).
  - canonical cross-loadings = direct contribution of one feature to the "opposite" variate (i.e. the one it is not a part of); e.g. corr(Y1, u).


The most accessible explanation + more detail is in the *Where does the Effect Come From?* section of [this](https://www.tandfonline.com/doi/abs/10.1207/s15327752jpa8401_09) paper.  
...
- Use in cog neuro, [here](https://www.nature.com/articles/s41598-020-67605-2) and []
- Review for cog neuro applications [here](https://onlinelibrary.wiley.com/doi/full/10.1002/hbm.25090)
- "Famous" Smith paper using it [here](http://www.nature.com/articles/nn.4125). I don't understand 
...
*Cons*:
 ...
 - Multicollinearity in either variate confounds interpretation of canonical results + leads to instability (different results on different runs).
 ...
 - No precise statistics for interpretation of CCA -> descriptives.

#### Factor analysis.

- Not quite sure what it is atm.
